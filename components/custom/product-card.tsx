...
import { Car, ChevronLeft, ChevronRight, ShoppingBasket } from "lucide-react";
    ...
    <div>
      <Tabs defaultValue="All" className="w-full">
        ...
        <TabsContent value={activeCategory} className="mt-0">
          <div className="grid gap-6 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6">
            {currentItems.map((item) => (
              <Card
                key={item.id}
                className="flex flex-col justify-between overflow-hidden h-[250px] w-full md:w-[300px]"
              >
